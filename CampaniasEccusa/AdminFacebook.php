         ...
         <div class="box box-danger">
           ...
           <div class="box-body">
             ...
             <table id="example2" class="table table-bordered table-hover">
               ...
               global $con;
               $sql =  "SELECT fb_id, tpl_nombre,atma_nombre, camp_nombre, tob_nombre, tco_nombre, fb_ordenes
                        FROM facebook, campania, tipo_plataforma, atipo_marca, tipo_objetivo, tipo_compra
                        where fb_categoria = 1
												and fb_plataforma = tpl_id
                        and fb_marca = atma_id

...
if (isset($_POST['enviar']))
{
        ...
        $sql = "SELECT concat(AUT_nombre,' | ','$objetivo',' | ','$rate_type',' | ',VLE_nombre,' | ','$Inicio_anuncio',' - ',tfo_nombre,' - ','$Identificador') as nombrecampania                FROM tipo_formato, ad_unit_type, video_length

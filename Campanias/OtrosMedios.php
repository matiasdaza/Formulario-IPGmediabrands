	...
	<body class="hold-transition skin-blue sidebar-mini">
        ...
        <small>Control panel</small>
			...
			<ol class="breadcrumb">
				...
				<li class="active">Otros Medios</li>
			</ol>
		</section>
		<?php
		...
		<section class="content">
			<div class="box box-primary" style="padding-left: 2%;">
				<div class="box-header with-border">
					<h3 class="box-title">Otros Medios</h3>
				</div>
				<!-- /.box-header -->

				<div class="box-body">
					<form role="form" action="AddOOH.php" method="POST">

						<!-- Nombre de campaña -->
						<div class="form-group">
							<label>Ingrese el nombre de campaña</label>
							<input type="text" class="form-control" name='nombreCampania' placeholder="Nombre de Campaña">
						</div>
						<!-- Plataforma -->
            <label>Cadreon</label>
            <div class="form-group">
            	<div class='radio'>
								<label>
									<input type='radio' name='Cadreon' value='Y' >Si</label>
							</div>
							<div class='radio'>
								<label>
									<input type='radio' name='Cadreon' value='N' >No</label>
							</div>
            </div>
						<!-- Medio -->
						<div class="form-group">
							<label>Ingrese el Medio</label>
							<input type="text" class="form-control" name='Medio' placeholder="">
						</div>
						...
						<div class="form-group">
						 <div class='radio'>
							 <label>
								 <input type='radio' name='tipo_compra' value='CPM' >CPM</label>
						 </div>
						 <div class='radio'>
							 <label>
								 <input type='radio' name='tipo_compra' value='CPC' >CPC</label>
						 </div>
						 <div class='radio'>
							 <label>
								 <input type='radio' name='tipo_compra' value='CPV' >CPV</label>
						 </div>
						 <div class='radio'>
							 <label>
								 <input type='radio' name='tipo_compra' value='CPL' >CPL (Cost per listen)</label>
						 </div>
						</div>
						...
						<div class="form-group">
						 <div class='radio'>
							 <label>
								 <input type='radio' name='plataforma' value='Views' >Views</label>
						 </div>
						 <div class='radio'>
							 <label>
								 <input type='radio' name='plataforma' value='Escuchas' >Escuchas</label>
						 </div>
						 <div class='radio'>
							 <label>
								 <input type='radio' name='plataforma' value='Banner' >Banner</label>
						 </div>
						</div>

	...
	<body class="hold-transition skin-blue sidebar-mini">
        ...
        <small>Control panel</small>
			...
			<ol class="breadcrumb">
				...
				<li class="active">Anuncios - AdWords</li>
			</ol>
		</section>
		<?php
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Anuncios - AdWords</h3>
        </div>
				...
				<?php
					 ...
					 $con->set_charset("utf8");
						 global $con;
						 $sql = "SELECT * FROM AdWords where adw_categoria = 4;";
						 $respuesta = $con -> query($sql);
						 $filas = mysqli_num_rows($respuesta);
					 ?>
				<div class="box-body">
					<form role="form" action="AddanuncioAdWords.php" method="POST">
                 ...
                 <?php
                    if($filas > 0)
                    {
                      ...
                      {
                        echo "<option value=".$result['ADW_ID'].">".$result["ADW_NOMBRE"],"</option>";
                      }
                    }
                    ?>
                 </select>
				...
				<div class="form-group">
					<label>Ingrese nombre del video</label>
        ...
        <div class="form-group">
           ...
           <?php
              ...
              ?>
				...
				<input type="text" class="form-control" placeholder="Ingrese identificador de nombre" name="Identificador">
        <div class="box-body">
          <div class="col-xs-4">
            <button type="submit" name="enviar" class="btn btn-primary btn-block btn-flat" value="1">Guardar y mostrar</button>
          </div>
        </div>
      </form>
		</section>

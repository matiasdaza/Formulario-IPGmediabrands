         ...
         <div class="box box-danger">
           ...
           <div class="box-body">
             ...
             <table id="example2" class="table table-bordered table-hover">
               ...
               global $con;
               $sql =  "SELECT adw_id, camp_nombre, tma_nombre, red_nombre, can_nombre, tob_nombre, adw_ordenes
												FROM adwords, campania, tipo_marca, red, canal, tipo_objetivo
												WHERE ADW_CAMPANIA = camp_id and ADW_MARCA = tma_id and adw_red = red_id and ADW_CANAL = can_id and ADW_OBJETIVO = tob_id

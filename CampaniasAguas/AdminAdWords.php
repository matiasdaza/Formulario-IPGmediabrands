         ...
         <div class="box box-danger">
           ...
           <div class="box-body">
             ...
             <table id="example2" class="table table-bordered table-hover">
               ...
               global $con;
               $sql =  "SELECT adw_id, camp_nombre, atma_nombre, red_nombre, can_nombre, adw_ordenes
												FROM adwords, campania, atipo_marca, red, canal
												WHERE ADW_CAMPANIA = camp_id and ADW_CATEGORIA = 1 and  ADW_MARCA = atma_id and adw_red = red_id and ADW_CANAL = can_id

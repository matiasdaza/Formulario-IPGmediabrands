  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Resumen Adwords</li>
      </ol>
    </section>
       ...
       if($filas > 0)
       {
        ...
        <label>Detalle de la campaña: </label>
          ...
          <?php
            ...
            global $con;
            $sql = "SELECT adw_id, camp_nombre, atma_nombre, red_nombre, can_nombre, tob_nombre,
            adw_ordenes, rty_nombre, adw_idate, adw_fdate, gen_nombre, adw_redad, adw_segmentacion, adw_frec, adw_frecdias, dis_nombre, adw_inversion
                     FROM adwords, campania, atipo_marca, red, canal, tipo_objetivo, Rate_type, genero, dispositivo
                     WHERE adw_id = $fbid and ADW_CAMPANIA = camp_id and ADW_MARCA = atma_id and adw_red = red_id and ADW_CANAL = can_id and ADW_OBJETIVO = tob_id

...
<html>
	...
	<body class="hold-transition skin-blue sidebar-mini">
        ...
        global $con;
        $sql = "SELECT * FROM CONJUNTO_ANUNCIOS WHERE COA_ID = $id;";
        ...
        if($filas > 0)
        {
          ...
          {
                $naming =  $resultinicial['COA_NOMBRE'];
      ...
      <div class="box box-primary">
        <form action='MUpdateCOA.php' method='POST' method='POST' role='form'>
        <br>
        <!-- Inicio_conjunto_anuncio -->
        <div class="form-group">
          <label>Nueva fecha de Inicio_conjunto_anuncio:</label>
          <?php
        ...
        <div class="form-group">
          <label>Nueva fecha de Fin_conjunto_anuncio:</label>
          <?php
          $fecha=date("Y")."-".date("m")."-".date("d");
        ...
        <div class="form-group">
          <label>Ingrese nueva inversión</label>

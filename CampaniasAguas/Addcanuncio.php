...
if (isset($_POST['enviar']))
{
        ...
        //echo "<p>",$hola=date("Y").date("m").date("d"),"</p>";
 $sql = "SELECT concat('Chile | ','$campania',' | ', '$objetivo',' | ', rty_nombre,' | ','$Inicio_conjunto_anuncio',' | ','$Fin_conjunto_anuncio',' | ','$Inversion','| | | | | ','$Identificador') as nombreconjanuncio                FROM rate_type

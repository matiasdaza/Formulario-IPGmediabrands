...
if (isset($_POST['enviar']))
{
        ...
        //Plataforma | País | Marca | Campaña global | Objetivo | Compra - Campo libre
        $sql = "SELECT concat(tpl_nombre,' | Chile | ',tma_nombre,' | ',camp_nombrecampania,' | ',tob_nombre,' | ',tco_nombre,' - ','$ordenes') as nombrecampania                FROM campania, tipo_plataforma, tipo_marca, tipo_objetivo, tipo_compra
